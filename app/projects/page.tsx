...
const TwoCheckDescription = () =>{
	...
	return (<div>
		...
		<p>L'équipe chez SEAROCCO était composée de 2 développeurs front-end y compris moi-même et 1 développeurs back-end, en plus du tech lead.</p><br />
		<p  style={{color: "#0081AB", cursor: "pointer", textAlign: "end", fontWeight: "bold", marginBottom: "10px", marginTop: "10px" }}
				onClick={() => setIsExpanded(!isExpanded)}
			>
				{isExpanded ? 'Lire moins' : 'Lire plus ...'}
	...
	return (
		<div>
			...
			{isExpanded && (
				<div>
					<p><br />
					<b> J'ai été responsable de la conception, de l'intégration ainsi que du développement front-end et back-end de cette solution.</b> <br/><br />
						<ul style={{listStyleType: "circle", paddingLeft: "15px"}}>
